// Background Decorations
    ...
    function checkPassword() {
      if (passwordInput.value.trim() === '3152009') {
    ...
    // Image Carousel
    const images = [
      'https://i.ibb.co/67DkzgRh/photo-2025-12-27-14-10-23.jpg',
      'https://i.ibb.co/WWFvm8Ts/photo-2025-12-27-14-10-21.jpg',
      'https://i.ibb.co/DP0JVNhs/image.png',
      'https://i.ibb.co/DdSSJ9y/image.png'
    ...
    function updateLoveTimer() {
      const startDate = new Date('2009-05-31T00:00:00');
      const now = new Date();
